...
export const createProductSchema = z.object({
  ...
  retailUnitName: z.string().trim().min(1).max(50).default("kg"),
  retailUnitGram: z.coerce.number().int().positive("Khối lượng một đơn vị bán lẻ phải lớn hơn 0.").default(1000),
  b2bUnitName: z.string().trim().min(1).max(50).default("kg"),
  b2bUnitGram: z.coerce.number().int().positive("Khối lượng một đơn vị B2B phải lớn hơn 0.").default(1000),
