      ...
      <section>
        <div className="hm-hero">
          <div className="mx-auto max-w-[1500px] px-6 py-24 lg:px-20 lg:py-28">
            <h1 className="hm-heading hm-hero-title max-w-6xl font-black uppercase leading-[1.08] text-white">
              Xưởng rang xay gia công cà phê Phú Tài Coffee Works
            </h1>
            <p className="mt-6 max-w-7xl text-xl font-bold leading-9 text-white md:text-2xl">
              Phú Tài nhận rang gia công, phối trộn và đóng gói cà phê theo yêu cầu
              cho quán, đại lý, doanh nghiệp F&B và thương hiệu riêng.
            </p>
            <p className="mt-7 max-w-6xl text-lg font-semibold leading-9 text-white/95 md:text-xl">
              Cam kết chất lượng ổn định, quy trình rõ ràng, tư vấn nhanh và sản lượng phù hợp
              cho khách hàng B2B cần nguồn hàng lâu dài.
            </p>
            <NavLink
              to="/dich-vu"
      ...
      <section className="hm-section grid items-center gap-16 bg-[#f2f2f2] lg:grid-cols-[1fr_1.05fr]">
        <Reveal>
          ...
          <p className="mt-10 max-w-3xl text-2xl leading-[1.9] text-stone-900">
            ...
            theo yêu cầu riêng, Phú Tài là lựa chọn phù hợp. Chúng tôi hỗ trợ từ chọn
      ...
      <section className="hm-section">
        ...
        <Reveal delay={100}>
          ...
          <div className="mx-auto mt-14 grid max-w-[1220px] items-center gap-16 lg:grid-cols-2">
            ...
            <p className="mt-8">
              Chúng tôi giúp khách hàng tiết kiệm thời gian thử nghiệm, giảm rủi ro
              chất lượng và có nguồn hàng ổn định để phát triển quán, đại lý hoặc
              thương hiệu cà phê riêng.
            </p>
            <ul className="mt-8 list-disc space-y-3 pl-8">
              <li>Cung cấp cà phê bột, cà phê hạt, drip bag, capsule và hòa tan.</li>
