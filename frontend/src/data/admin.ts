...
export const adminNavItems: AdminNavItem[] = [
  ...
  { label: "Đổi trả", to: "/admin/doi-tra", icon: RotateCcw },
  { label: "Đánh giá", to: "/admin/danh-gia", icon: MessageSquareMore },
  { label: "Báo giá B2B", to: "/admin/bao-gia", icon: FileText },
  { label: "Hợp đồng & công nợ", to: "/admin/b2b/tai-chinh", icon: Landmark },
  ...
  { label: "Giá sản phẩm", to: "/admin/chinh-sach-gia", icon: BadgeDollarSign },
